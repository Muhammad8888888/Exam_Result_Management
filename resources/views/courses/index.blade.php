...
<!-- Top Navigation -->
    ...
    <div class="max-w-7xl mx-auto mt-10 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('courses.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded">
                Add New Course
            </a>
        </div>
                    ...
                    @foreach($courses as $index => $course)
                        <tr>
                            ...
                            <td class="px-6 py-4 flex space-x-2">
                                <a href="{{ route('courses.edit', $course->id) }}" class="bg-yellow-500 hover:bg-yellow-600 text-white py-1 px-3 rounded text-xs">Edit</a>
