...
<body class="bg-gradient-to-r gap-5 from-blue-100 to-indigo-200 min-h-screen flex flex-col">
    ...
    <header class="flex justify-between items-center p-6 bg-white shadow">
        ...
        <div class="space-x-4">
            <a href="<?php echo e(route('login')); ?>" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition">Sign In</a>
            <a href="<?php echo e(route('register')); ?>" class="bg-gray-700 text-white px-4 py-2 rounded hover:bg-gray-800 transition">Sign Up</a>
        </div>
    </header>
    ...
    <main class="flex-grow flex flex-col items-center justify-center text-center px-4 mt-16">
        <div>
            ...
            <img src="<?php echo e(asset('images/hero.jpg')); ?>" alt="Exam System" class="mx-auto mb-8 rounded shadow-lg w-full max-w-xl">

            <a href="<?php echo e(route('login')); ?>" class="px-6 py-3 bg-blue-600 text-white text-lg rounded shadow hover:bg-blue-700 transition">
                Get Started
            </a>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20 text-left">
            ...
            <div class="bg-white p-6 rounded shadow hover:shadow-lg transition text-center">
                <img src="<?php echo e(asset('images/student.jpg')); ?>" alt="Student" class="w-24 h-24 mx-auto mb-4">
            ...
            <div class="bg-white p-6 rounded shadow hover:shadow-lg transition text-center">
                <img src="<?php echo e(asset('images/exam.jpg')); ?>" alt="Exam" class="w-24 h-24 mx-auto mb-4">
            ...
            <div class="bg-white p-6 rounded shadow hover:shadow-lg transition text-center">
                <img src="<?php echo e(asset('images/result.jpg')); ?>" alt="Result" class="w-24 h-24 mx-auto mb-4">
    ...
    <footer class="text-center p-4 bg-white mt-auto shadow text-sm text-gray-500">
        &copy; <?php echo e(date('Y')); ?> Exam and Result Management System. All rights reserved.
    </footer>

</body>
</html>
<?php /**PATH C:\Users\biolo\Downloads\zipzip\exam_result_system\resources\views/welcome.blade.php ENDPATH**/ ?>